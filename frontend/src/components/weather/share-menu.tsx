...
import { SiX, SiInstagram, SiSlack } from "@icons-pack/react-simple-icons";
export default function ShareMenu() {
  ...
  const handleShare = (platform: string) => {
    ...
    const text = encodeURIComponent(
      "Check out this climate twin match I found!"
    );
  ...
  return (
    <DropdownMenu>
      ...
      >
        ...
        >
          <SiX className="h-4 w-4 text-gray-400" />
        ...
        >
          <SiInstagram className="h-4 w-4 text-gray-400" />
        ...
        >
          <SiSlack className="h-4 w-4 text-gray-400" />
